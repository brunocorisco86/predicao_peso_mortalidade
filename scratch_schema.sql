CREATE TABLE IF NOT EXISTS "peso_abate" (
"lote_composto" TEXT,
  "idade_abate" INTEGER,
  "data_producao" TEXT,
...
CREATE TABLE IF NOT EXISTS "extracao_mtech_data" (
...
CREATE TABLE IF NOT EXISTS "lote_sampling_confidence" (
"lote_composto" TEXT,
  "fazenda" REAL,
...
CREATE TABLE IF NOT EXISTS "lote_rn12_digital_twins" (
"lote_composto" TEXT,
  "fazenda" REAL,
  "score_confianca_lote" REAL,
  "categoria_amostragem" TEXT,
